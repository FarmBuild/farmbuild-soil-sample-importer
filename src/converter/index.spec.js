describe('farmbuild.soilSampleImporter module: soilSampleConverter', function () {
  ...
  describe('soilSampleConverter factory', function () {
    ...
    it('soilSampleConverter farmdata should have the toSoilSampleResults included', inject(function () {
...
//      $log.info('farmDataWithSoilSamples after conversion '+JSON.stringify(farmDataWithSoilSamples,null,'    '));
      ...
      var classificationColumnDictionary = sampleResults.classificationColumnDictionary;
      expect(classificationColumnDictionary).toBeDefined();
